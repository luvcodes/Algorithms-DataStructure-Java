...
/**
 * @author yangrunze
 * LeetCode997: https://leetcode.cn/problems/squares-of-a-sorted-array/description/
...
public class SquareSortedArray977 {
     ...
     * 4. 添加的判断逻辑：比较原数组的左指针指向元素的平方和右指针指向元素的平方，哪个值更大，存储哪一个到新数组中
     * 5. 存储完成之后，将原数组存储进去的那个元素的所属指针，向原数组中心移动
     */
